...
export default function Ligue1StandingsAndFixtures() {
    ...
    return (
        <div className="container mx-auto p-6 pt-20 mt-10">
            <h1 className="text-4xl font-bold text-center text-indigo-700 mb-10">Ligue 1</h1>
